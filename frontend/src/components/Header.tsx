import { MapPin, LogOut, User, History, LayoutDashboard, Settings, Crown, Mail, Database } from "lucide-react";
...
export function Header() {
  ...
  const navItems = [
    ...
    { href: "/leads", label: "Base de Leads", icon: Database },
    { href: "/email-campaigns", label: "Campanhas", icon: Mail },
